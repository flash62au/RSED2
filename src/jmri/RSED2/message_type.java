...
//    int REQ_DIRECTION = 21;     // ed -> ta , pass whichThrottle, (requests direction from WiT)
    ...
    //R.S.E.D. Start
    int BT_THROTTLE = 136;        // bluetooth
    int BT_FUNCTION = 137;        // bluetooth
    int BT_DIRECTION = 138;       // bluetooth
    int BT_STOP = 139;            // bluetooth
    int BT_NEXT_THROTTLE = 140;   // bluetooth
    int BT_ESTOP = 141;           // bluetooth
    //R.S.E.D. Start
}
